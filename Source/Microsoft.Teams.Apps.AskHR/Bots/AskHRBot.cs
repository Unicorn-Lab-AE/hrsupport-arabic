...
namespace Microsoft.Teams.Apps.AskHR.Bots
{
    ...
    public class AskHRBot : ActivityHandler
    {
        ...
        /// </summary>
        public const string TeamTour = "قم بجولة للفريق";

        /// <summary>
        /// TakeAtour - text that triggers take a tour action for the user.
        /// </summary>
        public const string TakeATour = "قم بجولة";

        /// <summary>
        /// AskAnExpert - text that renders the ask an expert card.
        /// </summary>
        public const string AskAnExpert = "اسأل الخبير";

        /// <summary>
        /// Feedback - text that renders share feedback card.
        /// </summary>
        public const string ShareFeedback = "مشاركة التعليقات";
